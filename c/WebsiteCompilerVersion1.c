...
int From_MD_Make_HTML(const char *LocateInputFolder)
{
  DIR *dir;
  struct direct *entry;
  dir = opendir(LocateInputFolder); // TODO check if this is correct. it needs a char, but this is const char
  char FileName[512];
  FILE *PointToFiles;
